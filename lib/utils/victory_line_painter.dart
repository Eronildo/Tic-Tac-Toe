...
class VictoryLinePainter extends CustomPainter {
  ...
  VictoryLinePainter(Victory victory) {
  ...
  void paint(Canvas canvas, Size size) {
    if (_victory.lineType == LineTypes.HORIZONTAL) {
      _drawHorizontalLine(_victory.row, size, canvas);
    } else if (_victory.lineType == LineTypes.VERTICAL) {
      _drawVerticalLine(_victory.column, size, canvas);
    } else if (_victory.lineType == LineTypes.DIAGONAL_ASCENDING) {
      _drawDiagonalLine(true, size, canvas);
    } else if (_victory.lineType == LineTypes.DIAGONAL_DESCENDING)
